...
bool operator==(const ::turtlebot_actions::TurtlebotMoveFeedback_<ContainerAllocator1> & lhs, const ::turtlebot_actions::TurtlebotMoveFeedback_<ContainerAllocator2> & rhs)
{
