...
bool operator==(const ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator1> & lhs, const ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator2> & rhs)
{
