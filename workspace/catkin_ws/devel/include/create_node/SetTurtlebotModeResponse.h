...
bool operator==(const ::create_node::SetTurtlebotModeResponse_<ContainerAllocator1> & lhs, const ::create_node::SetTurtlebotModeResponse_<ContainerAllocator2> & rhs)
{
  return lhs.valid_mode == rhs.valid_mode;
}
...
struct Definition< ::create_node::SetTurtlebotModeResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bool valid_mode # will return false if a unvalid mode was requested\n"
;
  }
