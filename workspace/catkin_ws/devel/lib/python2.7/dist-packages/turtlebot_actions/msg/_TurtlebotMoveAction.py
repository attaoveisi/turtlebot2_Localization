...
"""autogenerated by genpy from turtlebot_actions/TurtlebotMoveAction.msg. Do not edit."""
import codecs
import sys
...
class TurtlebotMoveAction(genpy.Message):
  _md5sum = "339929f411dcfd188670046028b412ee"
  _type = "turtlebot_actions/TurtlebotMoveAction"
...
"""
  ...
  _slot_types = ['turtlebot_actions/TurtlebotMoveActionGoal','turtlebot_actions/TurtlebotMoveActionResult','turtlebot_actions/TurtlebotMoveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TurtlebotMoveAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = turtlebot_actions.msg.TurtlebotMoveActionGoal()
      if self.action_result is None:
        self.action_result = turtlebot_actions.msg.TurtlebotMoveActionResult()
      if self.action_feedback is None:
        self.action_feedback = turtlebot_actions.msg.TurtlebotMoveActionFeedback()
    else:
      self.action_goal = turtlebot_actions.msg.TurtlebotMoveActionGoal()
      self.action_result = turtlebot_actions.msg.TurtlebotMoveActionResult()
      self.action_feedback = turtlebot_actions.msg.TurtlebotMoveActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.turn_distance, _x.action_goal.goal.forward_distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.turn_distance, _x.action_result.result.forward_distance, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.turn_distance, _x.action_feedback.feedback.forward_distance,) = _get_struct_2f().unpack(str[start:end])
      return self
