...
"""autogenerated by genpy from turtlebot_actions/FindFiducialActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class FindFiducialActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "turtlebot_actions/FindFiducialActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot_actions/FindFiducialFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindFiducialActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = turtlebot_actions.msg.FindFiducialFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = turtlebot_actions.msg.FindFiducialFeedback()
