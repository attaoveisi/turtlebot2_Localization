...
"""autogenerated by genpy from stdr_msgs/CO2SensorMsg.msg. Do not edit."""
import codecs
import sys
...
class CO2SensorMsg(genpy.Message):
  _md5sum = "a2ce066e5e102e00628fbb7d1ee5e32b"
  _type = "stdr_msgs/CO2SensorMsg"
...
float64 theta
"""
  __slots__ = ['maxRange','frequency','frame_id','pose']
  _slot_types = ['float32','float32','string','geometry_msgs/Pose2D']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       maxRange,frequency,frame_id,pose
    ...
    """
    if args or kwds:
      super(CO2SensorMsg, self).__init__(*args, **kwds)
