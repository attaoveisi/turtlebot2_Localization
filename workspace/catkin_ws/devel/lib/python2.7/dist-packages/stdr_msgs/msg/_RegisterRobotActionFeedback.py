...
"""autogenerated by genpy from stdr_msgs/RegisterRobotActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RegisterRobotActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "stdr_msgs/RegisterRobotActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','stdr_msgs/RegisterRobotFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RegisterRobotActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = stdr_msgs.msg.RegisterRobotFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = stdr_msgs.msg.RegisterRobotFeedback()
