...
"""autogenerated by genpy from stdr_msgs/DeleteRobotActionResult.msg. Do not edit."""
import codecs
import sys
...
class DeleteRobotActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "stdr_msgs/DeleteRobotActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','stdr_msgs/DeleteRobotResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DeleteRobotActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = stdr_msgs.msg.DeleteRobotResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = stdr_msgs.msg.DeleteRobotResult()
