...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.result.description.initialPose.x, _x.result.description.initialPose.y, _x.result.description.initialPose.theta))
      length = len(self.result.description.footprint.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.description.footprint.points:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.result.description.footprint.radius
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.description.initialPose.x, _x.result.description.initialPose.y, _x.result.description.initialPose.theta,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (self.result.description.footprint.radius,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      if python3:
        self.result.description.kinematicModel.type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.description.kinematicModel.type = str[start:end]
      _x = self
      start = end
      end += 48
      (_x.result.description.kinematicModel.a_ux_ux, _x.result.description.kinematicModel.a_ux_uy, _x.result.description.kinematicModel.a_ux_w, _x.result.description.kinematicModel.a_uy_ux, _x.result.description.kinematicModel.a_uy_uy, _x.result.description.kinematicModel.a_uy_w, _x.result.description.kinematicModel.a_w_ux, _x.result.description.kinematicModel.a_w_uy, _x.result.description.kinematicModel.a_w_w, _x.result.description.kinematicModel.a_g_ux, _x.result.description.kinematicModel.a_g_uy, _x.result.description.kinematicModel.a_g_w,) = _get_struct_12f().unpack(str[start:end])
      return self
