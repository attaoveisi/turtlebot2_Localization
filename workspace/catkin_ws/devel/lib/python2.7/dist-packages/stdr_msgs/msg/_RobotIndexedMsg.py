...
"""autogenerated by genpy from stdr_msgs/RobotIndexedMsg.msg. Do not edit."""
import codecs
import sys
...
class RobotIndexedMsg(genpy.Message):
  _md5sum = "f74cd2b918be4e39c8fb0e1bebbbf480"
  _type = "stdr_msgs/RobotIndexedMsg"
...
"""
  ...
  _slot_types = ['string','stdr_msgs/RobotMsg']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RobotIndexedMsg, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.name is None:
        self.name = ''
      if self.robot is None:
        self.robot = stdr_msgs.msg.RobotMsg()
    else:
      self.name = ''
      self.robot = stdr_msgs.msg.RobotMsg()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3d().pack(_x.robot.initialPose.x, _x.robot.initialPose.y, _x.robot.initialPose.theta))
      length = len(self.robot.footprint.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.footprint.points:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.robot.footprint.radius
      buff.write(_get_struct_f().pack(_x))
      length = len(self.robot.laserSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.laserSensors:
        _x = val1
      ...
      length = len(self.robot.sonarSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.sonarSensors:
        _x = val1
        ...
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.robot.rfidSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.rfidSensors:
        _x = val1
        ...
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.robot.co2Sensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.co2Sensors:
        _x = val1
        ...
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.robot.soundSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.soundSensors:
        _x = val1
        ...
        _x = _v7
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.robot.thermalSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.robot.thermalSensors:
        _x = val1
        buff.write(_get_struct_3f().pack(_x.maxRange, _x.frequency, _x.angleSpan))
        _x = val1.frame_id
        length = len(_x)
        ...
        _x = _v8
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      _x = self.robot.kinematicModel.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_12f().pack(_x.robot.kinematicModel.a_ux_ux, _x.robot.kinematicModel.a_ux_uy, _x.robot.kinematicModel.a_ux_w, _x.robot.kinematicModel.a_uy_ux, _x.robot.kinematicModel.a_uy_uy, _x.robot.kinematicModel.a_uy_w, _x.robot.kinematicModel.a_w_ux, _x.robot.kinematicModel.a_w_uy, _x.robot.kinematicModel.a_w_w, _x.robot.kinematicModel.a_g_ux, _x.robot.kinematicModel.a_g_uy, _x.robot.kinematicModel.a_g_w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot.initialPose.x, _x.robot.initialPose.y, _x.robot.initialPose.theta,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.footprint.points = []
      for i in range(0, length):
        ...
        self.robot.footprint.points.append(val1)
      start = end
      end += 4
      (self.robot.footprint.radius,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.laserSensors = []
      for i in range(0, length):
        ...
        self.robot.laserSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.sonarSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.robot.sonarSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.rfidSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.robot.rfidSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.co2Sensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.robot.co2Sensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.soundSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.robot.soundSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.robot.thermalSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.robot.thermalSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.robot.kinematicModel.type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.robot.kinematicModel.type = str[start:end]
      _x = self
      start = end
      end += 48
      (_x.robot.kinematicModel.a_ux_ux, _x.robot.kinematicModel.a_ux_uy, _x.robot.kinematicModel.a_ux_w, _x.robot.kinematicModel.a_uy_ux, _x.robot.kinematicModel.a_uy_uy, _x.robot.kinematicModel.a_uy_w, _x.robot.kinematicModel.a_w_ux, _x.robot.kinematicModel.a_w_uy, _x.robot.kinematicModel.a_w_w, _x.robot.kinematicModel.a_g_ux, _x.robot.kinematicModel.a_g_uy, _x.robot.kinematicModel.a_g_w,) = _get_struct_12f().unpack(str[start:end])
      return self
