...
"""autogenerated by genpy from stdr_msgs/RegisterRobotAction.msg. Do not edit."""
import codecs
import sys
...
class RegisterRobotAction(genpy.Message):
  _md5sum = "b39b50bd76f14707645fb1a5dcce213f"
  _type = "stdr_msgs/RegisterRobotAction"
...
"""
  ...
  _slot_types = ['stdr_msgs/RegisterRobotActionGoal','stdr_msgs/RegisterRobotActionResult','stdr_msgs/RegisterRobotActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RegisterRobotAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = stdr_msgs.msg.RegisterRobotActionGoal()
      if self.action_result is None:
        self.action_result = stdr_msgs.msg.RegisterRobotActionResult()
      if self.action_feedback is None:
        self.action_feedback = stdr_msgs.msg.RegisterRobotActionFeedback()
    else:
      self.action_goal = stdr_msgs.msg.RegisterRobotActionGoal()
      self.action_result = stdr_msgs.msg.RegisterRobotActionResult()
      self.action_feedback = stdr_msgs.msg.RegisterRobotActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d().pack(_x.action_result.result.description.initialPose.x, _x.action_result.result.description.initialPose.y, _x.action_result.result.description.initialPose.theta))
      length = len(self.action_result.result.description.footprint.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.footprint.points:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self.action_result.result.description.footprint.radius
      buff.write(_get_struct_f().pack(_x))
      length = len(self.action_result.result.description.laserSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.laserSensors:
        _x = val1
      ...
      length = len(self.action_result.result.description.sonarSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.sonarSensors:
        _x = val1
        ...
        _x = _v4
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.action_result.result.description.rfidSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.rfidSensors:
        _x = val1
        ...
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.action_result.result.description.co2Sensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.co2Sensors:
        _x = val1
        ...
        _x = _v6
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.action_result.result.description.soundSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.soundSensors:
        _x = val1
        ...
        _x = _v7
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      length = len(self.action_result.result.description.thermalSensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.description.thermalSensors:
        _x = val1
        buff.write(_get_struct_3f().pack(_x.maxRange, _x.frequency, _x.angleSpan))
        _x = val1.frame_id
        length = len(_x)
        ...
        _x = _v8
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.theta))
      _x = self.action_result.result.description.kinematicModel.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_12f3I().pack(_x.action_result.result.description.kinematicModel.a_ux_ux, _x.action_result.result.description.kinematicModel.a_ux_uy, _x.action_result.result.description.kinematicModel.a_ux_w, _x.action_result.result.description.kinematicModel.a_uy_ux, _x.action_result.result.description.kinematicModel.a_uy_uy, _x.action_result.result.description.kinematicModel.a_uy_w, _x.action_result.result.description.kinematicModel.a_w_ux, _x.action_result.result.description.kinematicModel.a_w_uy, _x.action_result.result.description.kinematicModel.a_w_w, _x.action_result.result.description.kinematicModel.a_g_ux, _x.action_result.result.description.kinematicModel.a_g_uy, _x.action_result.result.description.kinematicModel.a_g_w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      (_x.action_result.result.description.initialPose.x, _x.action_result.result.description.initialPose.y, _x.action_result.result.description.initialPose.theta,) = _get_struct_3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.footprint.points = []
      for i in range(0, length):
        ...
        self.action_result.result.description.footprint.points.append(val1)
      start = end
      end += 4
      (self.action_result.result.description.footprint.radius,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.laserSensors = []
      for i in range(0, length):
        ...
        self.action_result.result.description.laserSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.sonarSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.action_result.result.description.sonarSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.rfidSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.action_result.result.description.rfidSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.co2Sensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.action_result.result.description.co2Sensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.soundSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.action_result.result.description.soundSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.description.thermalSensors = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.theta,) = _get_struct_3d().unpack(str[start:end])
        self.action_result.result.description.thermalSensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.description.kinematicModel.type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.description.kinematicModel.type = str[start:end]
      _x = self
      start = end
      end += 60
      (_x.action_result.result.description.kinematicModel.a_ux_ux, _x.action_result.result.description.kinematicModel.a_ux_uy, _x.action_result.result.description.kinematicModel.a_ux_w, _x.action_result.result.description.kinematicModel.a_uy_ux, _x.action_result.result.description.kinematicModel.a_uy_uy, _x.action_result.result.description.kinematicModel.a_uy_w, _x.action_result.result.description.kinematicModel.a_w_ux, _x.action_result.result.description.kinematicModel.a_w_uy, _x.action_result.result.description.kinematicModel.a_w_w, _x.action_result.result.description.kinematicModel.a_g_ux, _x.action_result.result.description.kinematicModel.a_g_uy, _x.action_result.result.description.kinematicModel.a_g_w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_12f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
