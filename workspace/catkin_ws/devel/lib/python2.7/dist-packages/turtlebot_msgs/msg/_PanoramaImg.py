...
"""autogenerated by genpy from turtlebot_msgs/PanoramaImg.msg. Do not edit."""
import codecs
import sys
...
class PanoramaImg(genpy.Message):
  ...
  _type = "turtlebot_msgs/PanoramaImg"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.pano_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.geo_tag = str[start:end].decode('utf-8', 'rosmsg')
      else:
