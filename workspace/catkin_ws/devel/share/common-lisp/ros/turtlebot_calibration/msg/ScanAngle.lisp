...
(cl:in-package turtlebot_calibration-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ScanAngle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanAngle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_calibration-msg:<ScanAngle> is deprecated: use turtlebot_calibration-msg:ScanAngle instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ScanAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_calibration-msg:header-val is deprecated.  Use turtlebot_calibration-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'scan_angle-val :lambda-list '(m))
(cl:defmethod scan_angle-val ((m <ScanAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_calibration-msg:scan_angle-val is deprecated.  Use turtlebot_calibration-msg:scan_angle instead.")
  (scan_angle m))
