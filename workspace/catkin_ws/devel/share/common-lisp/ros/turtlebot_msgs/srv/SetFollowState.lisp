...
(cl:defmethod cl:initialize-instance :after ((m <SetFollowState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFollowState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_msgs-srv:<SetFollowState-request> is deprecated: use turtlebot_msgs-srv:SetFollowState-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetFollowState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-srv:state-val is deprecated.  Use turtlebot_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetFollowState-request>)))
  ...
  (cl:format cl:nil "uint8 STOPPED = 0~%uint8 FOLLOW  = 1~%~%# Following running/stopped~%uint8 state~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetFollowState-request)))
  "Returns full string definition for message of type 'SetFollowState-request"
  (cl:format cl:nil "uint8 STOPPED = 0~%uint8 FOLLOW  = 1~%~%# Following running/stopped~%uint8 state~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetFollowState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFollowState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_msgs-srv:<SetFollowState-response> is deprecated: use turtlebot_msgs-srv:SetFollowState-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SetFollowState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_msgs-srv:result-val is deprecated.  Use turtlebot_msgs-srv:result instead.")
  (result m))
