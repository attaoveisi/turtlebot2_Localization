...
class DeleteThermalSourceRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteThermalSourceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteThermalSourceRequest(null);
...
class DeleteThermalSourceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteThermalSourceResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteThermalSourceResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'stdr_msgs/DeleteThermalSource'; }
};
