...
class DeleteCO2SourceRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteCO2SourceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteCO2SourceRequest(null);
...
class DeleteCO2SourceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteCO2SourceResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteCO2SourceResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'stdr_msgs/DeleteCO2Source'; }
};
