...
class DeleteSoundSourceRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteSoundSourceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteSoundSourceRequest(null);
...
class DeleteSoundSourceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteSoundSourceResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteSoundSourceResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'stdr_msgs/DeleteSoundSource'; }
};
