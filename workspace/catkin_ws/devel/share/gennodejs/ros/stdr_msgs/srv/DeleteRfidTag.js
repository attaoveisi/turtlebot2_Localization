...
class DeleteRfidTagRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteRfidTagRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteRfidTagRequest(null);
...
class DeleteRfidTagResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteRfidTagResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteRfidTagResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'stdr_msgs/DeleteRfidTag'; }
};
