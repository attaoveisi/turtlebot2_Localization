...
class SpawnRobotResult {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.indexedDescription = null;
      this.message = null;
    }
    else {
      if (initObj.hasOwnProperty('indexedDescription')) {
        this.indexedDescription = initObj.indexedDescription
      }
      else {
        this.indexedDescription = new RobotIndexedMsg();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [indexedDescription]
    bufferOffset = RobotIndexedMsg.serialize(obj.indexedDescription, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpawnRobotResult(null);
    // Deserialize message field [indexedDescription]
    data.indexedDescription = RobotIndexedMsg.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += RobotIndexedMsg.getMessageSize(object.indexedDescription);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpawnRobotResult(null);
    if (msg.indexedDescription !== undefined) {
      resolved.indexedDescription = RobotIndexedMsg.Resolve(msg.indexedDescription)
    }
    else {
      resolved.indexedDescription = new RobotIndexedMsg()
    }
...
module.exports = SpawnRobotResult;
