...
class DeleteRobotActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new DeleteRobotResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DeleteRobotResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteRobotActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = DeleteRobotResult.Resolve(msg.result)
    }
    else {
      resolved.result = new DeleteRobotResult()
    }
...
module.exports = DeleteRobotActionResult;
