...
class SpawnRobotActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SpawnRobotFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SpawnRobotFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpawnRobotActionFeedback(null);
    ...
    data.feedback = SpawnRobotFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpawnRobotActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SpawnRobotFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SpawnRobotFeedback()
    }
...
module.exports = SpawnRobotActionFeedback;
