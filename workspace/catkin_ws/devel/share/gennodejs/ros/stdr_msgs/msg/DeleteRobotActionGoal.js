...
class DeleteRobotActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DeleteRobotGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += DeleteRobotGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteRobotActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DeleteRobotGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DeleteRobotGoal()
    }
...
module.exports = DeleteRobotActionGoal;
