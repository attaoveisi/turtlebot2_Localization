...
class DeleteRobotActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new DeleteRobotFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DeleteRobotFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DeleteRobotActionFeedback(null);
    ...
    data.feedback = DeleteRobotFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DeleteRobotActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DeleteRobotFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DeleteRobotFeedback()
    }
...
module.exports = DeleteRobotActionFeedback;
