...
class SoundSensorMeasurementMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('sound_dbs')) {
        this.sound_dbs = initObj.sound_dbs
      }
      else {
        this.sound_dbs = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.sound_dbs, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SoundSensorMeasurementMsg(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [sound_dbs]
    data.sound_dbs = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SoundSensorMeasurementMsg(null);
    ...
    if (msg.sound_dbs !== undefined) {
      resolved.sound_dbs = msg.sound_dbs;
    }
    else {
      resolved.sound_dbs = 0.0
    }
