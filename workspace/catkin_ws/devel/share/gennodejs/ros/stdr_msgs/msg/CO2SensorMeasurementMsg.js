...
class CO2SensorMeasurementMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('co2_ppm')) {
        this.co2_ppm = initObj.co2_ppm
      }
      else {
        this.co2_ppm = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.co2_ppm, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CO2SensorMeasurementMsg(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [co2_ppm]
    data.co2_ppm = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CO2SensorMeasurementMsg(null);
    ...
    if (msg.co2_ppm !== undefined) {
      resolved.co2_ppm = msg.co2_ppm;
    }
    else {
      resolved.co2_ppm = 0.0
    }
