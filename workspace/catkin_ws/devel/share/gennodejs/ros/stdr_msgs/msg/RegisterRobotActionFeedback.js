...
class RegisterRobotActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RegisterRobotFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RegisterRobotFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RegisterRobotActionFeedback(null);
    ...
    data.feedback = RegisterRobotFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RegisterRobotActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RegisterRobotFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RegisterRobotFeedback()
    }
...
module.exports = RegisterRobotActionFeedback;
