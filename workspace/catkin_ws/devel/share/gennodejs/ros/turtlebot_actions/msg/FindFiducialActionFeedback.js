...
class FindFiducialActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new FindFiducialFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FindFiducialFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FindFiducialActionFeedback(null);
    ...
    data.feedback = FindFiducialFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindFiducialActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FindFiducialFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FindFiducialFeedback()
    }
...
module.exports = FindFiducialActionFeedback;
