...
class FindFiducialActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FindFiducialGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FindFiducialGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FindFiducialActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FindFiducialGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FindFiducialGoal()
    }
